...
int main(void)
{
  ...
  Lcd_cursor(&lcd,0,1);
  Lcd_string(&lcd,"Bharath");
  Lcd_cursor(&lcd,1,1);
  Lcd_string(&lcd,"212221230013");
...
## Output screen shots of proteus  :
 ![image](https://github.com/Bharath745/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/94508354/3a8ee1ed-fa51-4b4c-b0b9-127c40019a28)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/Bharath745/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/94508354/a1d2b1af-ce14-4e7a-84f4-390d4149bee8)
